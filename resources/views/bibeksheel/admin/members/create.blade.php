                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('nepali_name') ? 'is-invalid' : '' }}" type="text"
                            name="nepali_name" id="nepali_name" value="{{ old('nepali_name', '') }}">
                        @error('nepali_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text"
                            name="mobile" id="mobile" required value="{{ old('mobile', '') }}">
                        @error('mobile')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        ...
                        <select
                            ...
                            @foreach (App\Member::HIGHEST_ACADEMIC_QUALIFICATION as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('highest_academic_qualification', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('current_country') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::CURRENT_COUNTRY_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('current_country', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('area_code') ? 'is-invalid' : '' }}" type="text"
                            name="area_code" id="area_code" value="{{ old('area_code', '') }}">
                        @error('area_code')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('blood_group') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::BLOOD_GROUPS_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('blood_group', 'blood_group') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @error('blood_group')
                    ...
                    <div class="form-group col-6">
                        ...
                        @foreach (App\Member::DISABILITY_SELECT as $key => $label)
                            <div
                                ...
                                <input class="form-check-input" type="radio" id="disability_{{ $key }}"
                                    name="disability" value="{{ $key }}"
                                    {{ old('disability', '') === (string) $key ? 'checked' : '' }}>
                                <label class="form-check-label"
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('municipality') ? 'is-invalid' : '' }}"
                            ...
                            <option value disabled {{ old('municipality', null) === null ? 'selected' : '' }}>
                                {{ trans('global.pleaseSelect') }}</option>
                            @foreach ($municipalities as $municipality)
                                <option value="{{ $municipality->id }}">{{ $municipality->municipality_code }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('ward_no') ? 'is-invalid' : '' }}" type="text"
                            name="ward_no" id="ward_no" value="{{ old('ward_no', '') }}">
                        @error('ward_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        <label for="toll">Tole</label>
                        <input class="form-control {{ $errors->has('toll_no') ? 'is-invalid' : '' }}" type="text"
                            name="toll_no" id="toll_no" value="{{ old('toll_no', '') }}">
                        @error('toll_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-12">
                        ...
                        <div
                            class="form-check form-check-inline {{ $errors->has('has_temporary_address') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" checked type="radio" id="has_temporary_address_false"
                    ...
                    <div class="form-row" id="temporary_address_modal" aria-hidden="true">
                        ...
                        <div class="form-group col-4">
                            ...
                            <select class="form-control {{ $errors->has('temporary_province') ? 'is-invalid' : '' }}"
                                ...
                                <option value disabled {{ old('temporary_province', null) === null ? 'selected' : '' }}>
                                    {{ trans('global.pleaseSelect') }}</option>
                                @foreach ($provinces as $province)
                                    <option value="{{ $province->id }}">{{ $province->name }}</option>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select class="form-control {{ $errors->has('temporary_district') ? 'is-invalid' : '' }}"
                                ...
                                <option value disabled {{ old('temporary_district', null) === null ? 'selected' : '' }}>
                                    {{ trans('global.pleaseSelect') }}</option>
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}">{{ $district->name }}</option>
                        ...
                        <div class="form-group col-4">
                            ...
                            <select
                                ...
                                <option value disabled
                                    {{ old('temporary_municipality', null) === null ? 'selected' : '' }}>
                                    {{ trans('global.pleaseSelect') }}</option>
                                @foreach ($municipalities as $municipality)
                                    <option value="{{ $municipality->id }}">{{ $municipality->municipality_code }}
                                    </option>
                    ...
                    <div class="form-row" id="foreign_address_modal" aria-hidden="true">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input
                                ...
                                value="{{ old('foreign_country_address', '') }}">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input class="form-control {{ $errors->has('foreign_country_city') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('foreign_country_city', '') }}">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input
                                ...
                                value="{{ old('foreign_country_zip_code', '') }}">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input class="form-control {{ $errors->has('foreign_country_number') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('foreign_country_number', '') }}">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('identity_type') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::IDENTITY_TYPE_SELECT as $key => $label)
                                <option required value="{{ $key }}"
                                    {{ old('identity_type', 'citizenship') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @error('identity_type')
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="custom-file-input" accept="image/jpeg,application/pdf" type="file"
                            name="identity_image" id="identity_image">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="custom-file-input" type="file" accept="image/*" name="photo_for_id_card"
                            id="photo_for_id_card">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('occupation') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::OCCUPATION_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('occupation', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @error('occupation')
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('availability') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::AVAILABILITY_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('availability', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @error('availability')
                        ...
                        <div
                            ...
                            @foreach (\App\Member::INTERESTED_DEPARTMENT_SELECT as $key => $value)
                                <input class="form-check-input" type="checkbox" name="interested_department[]"
                                    id="interested_department" value="{{ $key }}"
                                    {{ old('interested_department', 0) == 1 ? 'checked' : '' }}>
                    ...
                    <div class="form-group col-12">
                        ...
                        <div
                            ...
                            @foreach (\App\Member::GROUP_SELECT as $key => $value)
                                <input class="form-check-input" type="checkbox" name="group[]" id="group"
                                    value="{{ $key }}" {{ old('group', 0) === $key ? 'checked' : '' }}>
                    ...
                    <div class="form-group col-4">
                        ...
                        <select
                            class="form-control {{ $errors->has('year_of_membership_period') ? 'is-invalid' : '' }}"
                            name="year_of_membership_period" id="year_of_membership_period">
                            <option value disabled
                                {{ old('year_of_membership_period', null) === null ? 'selected' : '' }}>
                                {{ trans('global.pleaseSelect') }}</option>
                            @foreach (App\Member::MEMBERSHIP_PERIOD as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('year_of_membership_period', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('membership_fee') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('membership_fee') }}" step="0.01">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('help_type') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::HELP_TYPE_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('help_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                        @error('help_type')
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('help_goods') ? 'is-invalid' : '' }}" type="text"
                            name="help_goods" id="help_goods" value="{{ old('help_goods', '') }}">
                        @error('help_goods')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('help_money') ? 'is-invalid' : '' }}" type="number"
                            name="help_money" id="help_money" value="{{ old('help_money') }}" step="0.01">
                        @error('help_money')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::CURRENCY_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('currency', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                        @error('currency')
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Member::PAYMENT_TYPE_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('payment_type', '') === (string) $key ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                        @error('payment_type')
                        ...
                        @foreach (App\Member::IS_PAID_RADIO as $key => $label)
                            <div class="form-check form-check-inline {{ $errors->has('is_paid') ? 'is-invalid' : '' }}">
                                <input class="form-check-input" type="radio" id="is_paid_{{ $key }}"
                                    ...
                                    {{ old('is_paid', '') === (string) $key ? 'checked' : '' }}>
                                <label class="form-check-label"
                    ...
                    <div class="form-group col-12">
                        ...
                        <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text"
                            name="remarks" id="remarks" value="{{ old('remarks', '') }}">
                        @error('remarks')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-12">
                        <input type="checkbox" name="is_agreed" id="is_agreed" value="1">
